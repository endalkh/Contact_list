class API {
  ...
  static const String UPCOMING_BIRTHDAY_API =
      COMMON_API + "/person/upcoming-birthdays";
  ...
  static const String GET_SINGLE_API = COMMON_API + "phone-number";
  ...
  static const String PHONE_SYNC = COMMON_API + "person/sync";
  ...
  static const String RESET_PASSWORD_API =
      "https://relateapp.io/api/v1/auth/reset-password?";
}
